...
def parse_pdr_sensor():
    ...
    if(isExist(pdr_file_name)):
        ...
        if (len(parse_pdr_sensor.pdr_timestamp_ns) == 0 or len(parse_pdr_sensor.pdr_sensor_position_update) == 0 or len(parse_pdr_sensor.pdr_positionUpdateMessage_x) == 0 or len(parse_pdr_sensor.pdr_positionUpdateMessage_y) == 0):
            pdr_file_empty()
...
message = """
    ...
    <div style="overflow-x:auto;">
            ...
            <table class="test-result-table" style="width:100%" cellspacing="0">
    		    ...
    		    <tr class="test-result-step-row test-result-step-row-altone">
                        <td rowspan="4" class="test-result-step-command-cell"> PedestrianDeadReckoning Sensor </td>
                        <td rowspan="4"> To Validate PedestrianDeadReckoning Sensor </td>
                        <td rowspan="2"> getSystemService </td>
                        <td > time-stamp </td>
                    ...
                    <tr>
                        <td rowspan="2"> getDefaultSensor(65546) </td> 
