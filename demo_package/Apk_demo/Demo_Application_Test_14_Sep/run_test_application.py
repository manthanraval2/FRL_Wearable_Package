...
subprocess.call("adb shell chmod 777 /data/local/tmp/startup_script.sh",shell=True)                          
subprocess.call("adb shell chmod 777 /data/local/tmp/frl_sensor_stress_test.sh",shell=True)                          
subprocess.call("rm -rf eInfochips",shell=True)
time.sleep(3)
...
while loop == 1:
    ...
    #subprocess.call('adb shell "mfg_tool mcu bbcmd shellcmd hrv_set"',shell=True)
    #print("\033[F",end = '')
